    ...
    public partial class ProductForm : Form
    {
        ...
        private void ProductForm_Load(object sender, EventArgs e)
        {
            ...
            if (product.isDiscounted == true)
            {
                ...
                priceLabel.Text = "$" + Math.Round((double) (product.productPrice - (product.productPrice * product.discountRate / 100)), 2);
            }
            else
            {
        ...
        private void postCommentButton_Click(object sender, EventArgs e)
        {
            ...
            if (MusicShopBL.InsertNewRating(new rating { comment = comment, ratingGrade = grade }, user, product))
            {
